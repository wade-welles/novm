...
type MmioDevice struct {
	...
	Offset kvm.Pointer `json:"address"`

	// Our assigned interrupt.
	InterruptNumber kvm.Irq `json:"interrupt"`
...
func (mmio *MmioDevice) Attach(vm *kvm.VirtualMachine, model *Model) error {
