...
func (stream *VirtioStream) ReadLeft() int  { return stream.VirtioBuffer.Length() - stream.read_offset }
func (stream *VirtioStream) ReadRewind()    { stream.read_offset = stream.bookmark }
func (stream *VirtioStream) WriteLeft() int { return stream.VirtioBuffer.Length() - stream.write_offset }
func (stream *VirtioStream) WriteRewind()   { stream.write_offset = stream.bookmark }
